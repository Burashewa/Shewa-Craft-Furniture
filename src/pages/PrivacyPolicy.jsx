    ...
    >
      ...
      <StaticSection title="Information we collect">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Messages you send to ShewaCraft Support or a product owner through
            in-app chat.
          </li>
          <li>
      ...
      <StaticSection title="How we use your information">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Respond to product questions through Chat with Owner and Messages.</li>
      ...
      <StaticSection title="Sharing">
        <p>
          ...
          complete an order — or when required by law. Product owners may see
