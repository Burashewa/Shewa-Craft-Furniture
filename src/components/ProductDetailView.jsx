      ...
      >
        <div className="min-h-full flex items-start md:items-center justify-center px-4 py-6 sm:py-8">
          <MotionDiv
            ...
            className="relative w-full max-w-6xl max-h-[90vh] bg-white border border-gray-200 shadow-xl overflow-hidden flex flex-col"
            {...modalMotion}
            transition={{ duration: prefersReducedMotion ? 0 : 0.2 }}
          ...
          >
            <button
              type="button"
              onClick={onClose}
              className={`absolute top-4 right-4 z-20 w-10 h-10 bg-white border border-gray-200 text-gray-700 hover:bg-gray-100 transition ${focusRing}`}
                    ...
                    {product.images.length > 1 && (
                      <>
                        <button
                          ...
                          className={`absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/95 flex items-center justify-center hover:bg-white transition shadow-sm ${focusRing}`}
                        ...
                        <button
                          ...
                          className={`absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/95 flex items-center justify-center hover:bg-white transition shadow-sm ${focusRing}`}
                      ...
                      {product.images.map((image, index) => {
                        ...
                        return (
                          <button
                            ...
                            className={`aspect-square overflow-hidden border-2 transition ${focusRing} ${
                              isActive
                  ...
                  <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2" role="group" aria-label="Color options">
                            {product.colors.map((color) => (
                              <button
                                ...
                                className={`px-4 py-2 border text-sm transition ${focusRing} ${
                                  selectedColor === color
                      ...
                      <div className="mb-6">
                        ...
                        >
                          <button
                            ...
                            className={`w-10 h-10 border border-gray-300 text-gray-700 hover:bg-gray-50 transition ${focusRing}`}
                    ...
                    <div className="space-y-3 mb-6">
                      <button
                        ...
                        className={`w-full px-6 py-4 bg-gray-900 text-white hover:bg-gray-800 transition disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${focusRing}`}
                      >
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <button
                          ...
                          className={`px-6 py-3 border transition flex items-center justify-center gap-2 disabled:border-gray-300 disabled:text-gray-400 disabled:hover:bg-transparent disabled:cursor-not-allowed ${focusRing} ${
                            favorited
                        ...
                        <button
                          ...
                          className={`px-6 py-3 border border-gray-900 text-gray-900 hover:bg-gray-50 transition flex items-center justify-center gap-2 disabled:border-gray-300 disabled:text-gray-400 disabled:hover:bg-transparent disabled:cursor-not-allowed ${focusRing}`}
                        >
